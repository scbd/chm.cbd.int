$compile.directive('search', function ($http) {
    return {
        restrict: 'EAC',
        templateUrl: '/app/abs/directives/search/search.partial.html',
        replace: true,
        // require : "?ngModel",
        scope: {
              // placeholder: '@',
        ...
        controller: ['$scope', '$q', function ($scope, $q)
        {
            ...
            function query() {
                ...
                var q = 'realm_s:absch AND ' + $scope.querySchema + ' AND ' + $scope.queryGovernment + ' AND ' + $scope.queryTheme + ' AND ' + $scope.queryBody + ' AND ' + $scope.queryDate + ' AND ' + $scope.queryKeywords + ' AND ' + $scope.query07 + ' AND ' + $scope.query08 + ' AND ' + $scope.query09 + ' AND ' + $scope.query10 + ' AND ' + $scope.query11 + ' AND ' + $scope.query12 + ' AND ' + $scope.query13;
...
//
//============================================================
$compile.directive('searchFacet', function ($http) {
    return {
        restrict: 'EAC',
        templateUrl: '/app/abs/directives/search/search-facet.partial.html',
        replace: true,
        // require : "?ngModel",
        scope: {
              // placeholder: '@',
...
//
//============================================================
$compile.directive('searchDate', function ($http) {
    return {
        restrict: 'EAC',
        templateUrl: '/app/abs/directives/search/search-date.partial.html',
        replace: true,
        scope: {
              title: '@title',
              query: '=query',
...
//
//============================================================
$compile.directive('searchKeywords', function ($http) {
    return {
        restrict: 'EAC',
        templateUrl: '/app/abs/directives/search/search-keywords.partial.html',
        // replace: true,
        // require : "?ngModel",
        scope: {
            // placeholder: '@',
