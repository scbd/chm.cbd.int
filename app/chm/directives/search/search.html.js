define(['app', 'moment', "utilities/km-utilities", "/app/chm/directives/search/search-filter-keywords.js", "/app/chm/directives/search/search-filter-schemas.js", "/app/chm/directives/search/search-filter-countries.js", "/app/chm/directives/search/search-filter-regions.js", "/app/chm/directives/search/search-filter-facets.js", "/app/chm/directives/search/search-filter-themes.js"], function(app, moment) { 'use strict';
	//==============================================
	//
	//
	//==============================================
	app.directive('search', function ($http) {
	    return {
	        restrict: 'EAC',
	        templateUrl: '/app/chm/directives/search/search.html',
	        replace: true,
	        scope: {
	        },
