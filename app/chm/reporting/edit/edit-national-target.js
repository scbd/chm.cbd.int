...
module.directive("chmEditNationalTarget", ['authHttp', "$q", "$filter", "URI", "IStorage", function ($http, $q, $filter, URI, storage) {
    return {
        restrict: 'EAC',
        templateUrl: '/app/chm/reporting/edit/edit-national-target.partial.html',
        replace: true,
        transclude: false,
        scope: {},
