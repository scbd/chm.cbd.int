define(['app', 'underscore', 'text!views/index.html', 'text!views/database/index.html',  'providers/extended-route', 'services/navigation'], function(app, _, rootTemplate, searchTemplate) { 'use strict';
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        //  when('/management/meetings/:meetingId/documents/:id', { templateUrl: 'views/management/meetings/documents/document-id.html', resolveController: true, resolveUser: true }).
            ...
            when('/management/edit/nationalIndicator',        { templateUrl: 'views/management/edit/national-indicator.html',       label : 'Edit NationalIndicator',       resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/management/edit/nationalReport',           { templateUrl: 'views/management/edit/national-report.html',          label : 'Edit NationalReport',          resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
