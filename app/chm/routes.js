define(['app', 'underscore', 'providers/extended-route', 'js/support'], function(app, _) { 'use strict';
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        $routeProvider.
            ...
            when('/database/',                                { templateUrl: 'views/database/index.html',                    resolveController: true,                                 resolveUser: true }).
            ...
            when('/management/national-reporting/:schema?',   { templateUrl: 'views/management/national-reporting.html',            controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { securized : securize(), dependencies : legacyResolver(['utilities/km-utilities']) } }).
            when('/management/my-records/:schema?',           { templateUrl: 'views/management/my-records.html',                    controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { securized : securize(), dependencies : legacyResolver(['utilities/km-utilities']) } }).
            when('/management/list/:schema?',                 { templateUrl: 'views/management/record-list.html',                   controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { securized : securize(), dependencies : legacyResolver(['utilities/km-utilities']) } }).
            when('/management/my-drafts',                     { templateUrl: 'views/management/my-drafts.html',                     controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { securized : securize(), dependencies : legacyResolver(['utilities/km-utilities']) } }).
