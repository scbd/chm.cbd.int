define(['text!./business-biodiversity-profile.html', 'app', 'angular', 'lodash', 'authentication', '../views/business-biodiversity-profile', 'services/editFormUtility', 'directives/forms/form-controls', 'utilities/km-utilities', 'utilities/km-workflows', 'utilities/km-storage'], function(template, app, angular, _) { 'use strict';
...
app.directive('editBusinessBiodiversityProfile', ['$http',"$rootScope", "Enumerable", "$filter", "$q", "guid", "$location", "Thesaurus", 'authentication', 'editFormUtility',  'IStorage', '$route', function ($http, $rootScope, Enumerable, $filter, $q, guid, $location, thesaurus, authentication, editFormUtility, storage, $route) {
	return {
		restrict   : 'E',
		template   : template,
		replace    : true,
