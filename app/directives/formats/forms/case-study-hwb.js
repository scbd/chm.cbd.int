define(['text!./case-study-hwb.html', 'app', 'angular', 'jquery', 'underscore', 'authentication', '../views/case-study', 'services/editFormUtility', 'directives/forms/form-controls', 'utilities/km-utilities', 'utilities/km-workflows', 'utilities/km-storage'], function(template, app, angular, $, _) { 'use strict';
