define(['text!./national-report.html', 'app', 'angular', 'underscore', 'authentication', '../views/national-report', 'authentication', 'services/editFormUtility', 'directives/forms/form-controls', 'utilities/km-utilities', 'utilities/km-workflows', 'utilities/km-storage', 'services/navigation'], function(template, app, angular, _) { 'use strict';
