define(['app', 'angular', 'lodash', 'text!./business-biodiversity-profile.html',
	'filters/mark-down', 'utilities/km-storage','scbd-angularjs-services/locale','filters/trust-as-resource-url'], function(app, angular, _, template){

app.directive('viewBusinessBiodiversityProfile', ["IStorage","$location","locale","$sce", function (storage,$location,locale,$sce) {
	return {
		restrict   : 'E',
		template   : template,
		replace    : true,
