    ...
    app.config(function($provide){
        ...
        $provide.decorator('taOptions', ['taRegisterTool', '$delegate', function(taRegisterTool, taOptions){
            ...
            taRegisterTool('uploadCustomImage', {
                ...
                action: function(){
                    uploadFile(this.$editor(), ".jpg, .jpeg, .bmp, .gif, .png");
                }
            });
            ...
            taOptions.toolbar[1].push('uploadCustomFile');
            ...
            function uploadFile(editor, supportedTypes){

                var uploadPlaceholder = $('input[name="' + editor._name + '"]').parent();                    
                uploadPlaceholder.children('input[type=file]').remove();
                uploadPlaceholder.prepend("<input type='file' style='display:none'" + (supportedTypes ? " accept='"+supportedTypes+"' " : "") + "/>");
