define(['app', 'providers/extended-route', 'js/support'], function(app) { 'use strict';
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        $routeProvider.
            ...
            when('/database/record',                          { templateUrl: '/app/views/database/record.html',                          controller: LEGACY_InnerPageController,           resolveUser: true, resolve : { dependencies : legacyResolver(['utilities/km-utilities', 'utilities/km-workflows', 'utilities/km-storage', 'directives/forms/form-controls.js']) } }).
            ...
            when('/management/edit/resource',                 { templateUrl: '/app/views/management/edit/resource.html',                 controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) } }).
            when('/management/edit/nationalReport',           { templateUrl: '/app/views/management/edit/nationalReport.html',           controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/nationalTarget',           { templateUrl: '/app/views/management/edit/nationalTarget.html',           controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/nationalIndicator',        { templateUrl: '/app/views/management/edit/nationalIndicator.html',        controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/progressAssessment',       { templateUrl: '/app/views/management/edit/progressAssessment.html',       controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/implementationActivity',   { templateUrl: '/app/views/management/edit/implementationActivity.html',   controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/nationalSupportTool',      { templateUrl: '/app/views/management/edit/nationalSupportTool.html',      controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/aichiTarget',              { templateUrl: '/app/views/management/edit/aichi-target.html',             controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/marineEbsa',               { templateUrl: '/app/views/management/edit/marine-ebsa.html',              controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/caseStudy',                { templateUrl: '/app/views/management/edit/case-study.html',               controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/caseStudyHwb',             { templateUrl: '/app/views/management/edit/case-study-hwb.html',           controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/resourceMobilisation',     { templateUrl: '/app/views/management/edit/resource-mobilisation.html',    controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/strategicPlanIndicator',   { templateUrl: '/app/views/management/edit/strategic-plan-indicator.html', controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/organization',             { templateUrl: '/app/views/management/edit/organization.html',             controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/contact',                  { templateUrl: '/app/views/management/edit/contact.html',                  controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
            when('/management/edit/database',                 { templateUrl: '/app/views/management/edit/database.html',                 controller: LEGACY_ManagementPageController,      resolveUser: true, resolve : { dependencies : legacyResolver(['/app/chm/services/editFormUtility.js', 'directives/forms/form-controls.js']) }, reloadOnSearch: false }).
