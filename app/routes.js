define(['app', 'lodash', 'text!views/index.html', 'text!views/database/index.html',  'providers/extended-route', 'services/navigation'], function(app, _, rootTemplate, searchTemplate) { 'use strict';
    ...
    //      when('/submit/online-reporting/:schema/:id',                <= final implementation goal
            ...
            when('/submit/online-reporting/progressAssessment/new',      { templateUrl: 'views/management/edit/progress-assessment.html',        label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/progressAssessment/:uid',     { templateUrl: 'views/management/edit/progress-assessment.html',        label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            ...
            when('/submit/online-reporting/resourceMobilisation/new',   { templateUrl: 'views/management/edit/resource-mobilisation.html',      label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/resourceMobilisation/:uid',  { templateUrl: 'views/management/edit/resource-mobilisation.html',      label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
