define(['app', 'lodash', 'text!views/index.html', 'text!views/database/index.html',  'providers/extended-route', 'services/navigation'], function(app, _, rootTemplate, searchTemplate) { 'use strict';
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        $routeProvider.
            ...
            when('/submit/financial_reporting',                { templateUrl: 'views/management/list/generic.html',      schema : "resourceMobilisation",  label : 'Financial Resource Mobilization',  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/financial_reporting/records',        { templateUrl: 'views/management/list/generic.html',      schema : "resourceMobilisation",  label : 'Records',                          resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            ...
            when('/submit/virtual_library',                    { templateUrl: 'views/management/list/generic.html',      schema : "resource",     label : 'Virtual Library',  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/virtual_library/records',            { templateUrl: 'views/management/list/generic.html',      schema : "resource",     label : 'Resources',        resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            ...
            when('/submit/case_studies',                       { templateUrl: 'views/management/list/generic.html',      schema : "caseStudy",    label : 'Case Study',       resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/case_studies/records',               { templateUrl: 'views/management/list/generic.html',      schema : "caseStudy",    label : 'Records',          resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            ...
            when('/submit/organizations',                      { templateUrl: 'views/management/list/generic.html',      schema : "organization", label : 'Biodiversity Related Organizations', resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/organizations/records',              { templateUrl: 'views/management/list/generic.html',      schema : "organization", label : 'Records',                            resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            ...
            when('/submit/ebsas',                              { templateUrl: 'views/management/list/generic.html',      schema : "marineEbsa",   label : 'EBSAs',            resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/ebsas/records',                      { templateUrl: 'views/management/list/generic.html',      schema : "marineEbsa",   label : 'Records',          resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            ...
            when('/submit/aichi_targets',                      { templateUrl: 'views/management/list/generic.html',      schema : "aichiTarget",  label : 'Aichi Targets',    resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/aichi_targets/records',              { templateUrl: 'views/management/list/generic.html',      schema : "aichiTarget",  label : 'Records',          resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            ...
            when('/submit/strategic_plan_indicators/records',  { templateUrl: 'views/management/list/generic.html',      schema : "strategicPlanIndicator",   label : 'Records',                    resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
