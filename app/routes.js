define(['app', 'lodash', 'text!views/index.html', 'text!views/database/index.html',  'providers/extended-route', 'services/navigation'], function(app, _, rootTemplate, searchTemplate) { 'use strict';
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        $routeProvider.
            ...
            when('/submit/online-reporting/nationalReport/nbsap',       { templateUrl: 'views/management/record-list.html',                     label: 'List',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/nationalReport/nr',          { templateUrl: 'views/management/record-list.html',                     label: 'List',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/nationalReport/other',       { templateUrl: 'views/management/record-list.html',                     label: 'List',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).

    //      when('/submit/online-reporting/:schema/:id',                <= final implementation goal
            when('/submit/online-reporting/nationalReport/:id',         { templateUrl: 'views/management/edit/national-report.html',            label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/nationalTarget/:id',         { templateUrl: 'views/management/edit/national-target.html',            label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/nationalIndicator/:id',      { templateUrl: 'views/management/edit/national-indicator.html',         label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/progressAssessment/:id',     { templateUrl: 'views/management/edit/progress-assessment.html',        label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/nationalSupportTool/:id',    { templateUrl: 'views/management/edit/national-support-tool.html',      label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/implementationActivity/:id', { templateUrl: 'views/management/edit/implementation-activity.html',    label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
    ...
    //      when('/submit/:schema/:id',                                 <= final implementation goal
            when('/submit/aichiTarget/:id',                             { templateUrl: 'views/management/edit/aichi-target.html',               label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/caseStudy/:id',                               { templateUrl: 'views/management/edit/case-study.html',                 label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/marineEbsa/:id',                              { templateUrl: 'views/management/edit/marine-ebsa.html',                label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/organization/:id',                            { templateUrl: 'views/management/edit/organization.html',               label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/resource/:id',                                { templateUrl: 'views/management/edit/resource.html',                   label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/resourceMobilisation/:id',                    { templateUrl: 'views/management/edit/resource-mobilisation.html',      label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/strategicPlanIndicator/:id',                  { templateUrl: 'views/management/edit/strategic-plan-indicator.html',   label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
