define(['app', 'lodash', 'text!views/index.html', 'text!views/database/index.html',  'providers/extended-route', 'services/navigation', 'services/realmConfig'], function(app, _, rootTemplate, searchTemplate) { 'use strict';
    ...
    //      when('/submit/online-reporting/:schema/:id',                <= final implementation goal
            ...
            when('/submit/online-reporting/nationalReport6/new',          { templateUrl: 'views/management/edit/national-report-6.html',            label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online-reporting/nationalReport6/:uid',         { templateUrl: 'views/management/edit/national-report-6.html',            label: 'Form',                  resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
