define(['app', 'lodash', 'text!views/index.html', 'text!views/database/index.html',  'providers/extended-route', 'services/navigation'], function(app, _, rootTemplate, searchTemplate) { 'use strict';
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        $routeProvider.
            ...
            when('/submit/online_reporting/records/nbsaps',                     { templateUrl: 'views/management/list/national-reports.html',   reportType : "nbsap",                  label : 'NBSAPS',                          resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online_reporting/records/national_reports',           { templateUrl: 'views/management/list/national-reports.html',   reportType : "nr",                     label : 'National Reports',                resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online_reporting/records/other_reports',              { templateUrl: 'views/management/list/national-reports.html',   reportType : "other",                  label : 'Other Reports',                   resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online_reporting/records/assessments',                { templateUrl: 'views/management/list/generic.html',            schema     : "progressAssessment",     label : 'Assessments',                     resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online_reporting/records/support_tools',              { templateUrl: 'views/management/list/generic.html',            schema     : "nationalSupportTool",    label : 'Guidance and Support Tools',      resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
            when('/submit/online_reporting/records/implementation_activities',  { templateUrl: 'views/management/list/generic.html',            schema     : "implementationActivity", label : 'Implementation Activities',       resolveController: true, resolveUser: true, resolve : { securized : securize() } }).
