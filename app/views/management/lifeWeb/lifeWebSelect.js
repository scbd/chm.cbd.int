define(['lodash', 'app', 'authentication', 'utilities/km-storage', 'utilities/km-workflows', "utilities/solr"], function(_) { 'use strict';
    ...
    return ['$scope', '$rootScope',"IStorage", "schemaTypes", '$timeout', '$route','$http','authentication','$q',"user","solr", 'navigation', '$mdDialog', '$location',
     function($scope, $rootScope, storage, schemaTypes, $timeout, $route,$http, authentication, $q, user,solr, navigation, $mdDialog, $location) {
         var realm = 'LIFEWEB';
